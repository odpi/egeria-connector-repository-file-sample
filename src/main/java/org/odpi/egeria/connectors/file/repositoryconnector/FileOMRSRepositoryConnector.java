...
//                                                                                     "refreshRepository");
                ...
                String guid = Base64.getUrlEncoder().encodeToString(canonicalName.getBytes(UTF_8));' or 'String guid = Base64.getUrlEncoder().encodeToString(canonicalName.getBytes(Charset.defaultCharset()));
