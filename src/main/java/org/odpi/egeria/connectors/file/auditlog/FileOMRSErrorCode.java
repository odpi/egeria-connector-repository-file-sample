...
public enum FileOMRSErrorCode implements ExceptionMessageSet {
    ...
    FOLDER_DOES_NOT_EXIST(400, "OMRS-FILE-REPOSITORY-400-069 ",
    ...
    NOT_A_FOLDER(400, "OMRS-FILE-REPOSITORY-400-070 ",
                 "The endpoint {0} in the configuration exists on the file system, but is not a folder. ",
                 "Connector is unable to be used",
                 "Review the Endpoint in the configuration to ensure it exists and points to a folder that exists."),
    UNABLE_TO_INITIALISE_CACHE(400, "OMRS-FILE-REPOSITORY-400-071 ",
                          "The cache failed to initialise",
                          "Connector is unable to be used",
                          "Review your configuration to ensure it is valid. Check the logs and debug."),
    IOEXCEPTION_ACCESSING_FILE(400, "OMRS-FILE-REPOSITORY-400-072 ",
    ...
    INVALID_PARAMETER_EXCEPTION(400, "OMRS-FILE-REPOSITORY-400-073 ",
                               "Invalid parameter exception",
                               "Connector is unable to be used",
                               "Review the configuration. Check the logs and debug."),

    REPOSITORY_ERROR_EXCEPTION(400, "OMRS-FILE-REPOSITORY-400-074 ",
                                "Repository error excpption",
                                "Connector is unable to be used",
                                "Review the configuration. Check the logs and debug."),
    TYPE_ERROR_EXCEPTION(400, "OMRS-FILE-REPOSITORY-400-075 ",
                         "Type error exception",
                         "Connector is unable to be used",
                         "Review the configuration. Check the logs and debug."),
    PROPERTY_ERROR_EXCEPTION(400, "OMRS-FILE-REPOSITORY-400-076 ",
                                "Property error exception",
                                "Connector is unable to be used",
                                "Review the configuration. Check the logs and debug."),
    PAGING_ERROR_EXCEPTION(400, "OMRS-FILE-REPOSITORY-400-077 ",
                             "Paging error exception",
                             "Connector is unable to be used",
                             "Review the configuration around paging. Check the logs and debug."),

    //    CLASSIFICATION_ERROR_EXCEPTION(400, "OMRS-FILE-REPOSITORY-400-077 ",
//                             "Classification error exception",
//                             "Connector is unable to be used",
//                             "Review the configuration. Check the logs and debug."),
//    STATUS_NOT_SUPPORTED_ERROR_EXCEPTION(400, "OMRS-FILE-REPOSITORY-400-078 ",
//                                   "Status not supported error exception",
//                                   "Connector is unable to be used",
//                                   "Review the configuration. Check the logs and debug."),
    FUNCTION_NOT_SUPPORTED_ERROR_EXCEPTION(400, "OMRS-FILE-REPOSITORY-400-079 ",
                                         "Function not supported error exception",
                                         "Connector is unable to be used",
                                         "Review the configuration. Check the logs and debug."),
    USER_NOT_AUTHORIZED_EXCEPTION(400, "OMRS-FILE-REPOSITORY-400-080 ",
                                         "user not authorized error exception",
                                         "Connector is unable to be used",
                                         "Review the configuration. Check the logs and debug."),
    HOME_ENTITY_ERROR_EXCEPTION(400, "OMRS-FILE-REPOSITORY-400-081 ",
                                "Reference copy requests have been issued on a home entity  error exception",
                                "Connector is unable to be used",
                                "Logic error. Check the logs and debug."),
    ENTITY_CONFLICT_ERROR_EXCEPTION(400, "OMRS-FILE-REPOSITORY-400-082 ",
                                    "Entity cannot be added as it conflicts with an entity that has already been stored",
                                    "Connector is unable to be used",
                                    "Logic error. Check the logs and debug."),

    INVALID_ENTITY_ERROR_EXCEPTION(400, "OMRS-FILE-REPOSITORY-400-083 ",
                                    "Entity cannot be added as it is invalid",
                                    "Connector is unable to be used",
                                    "Logic error. Check the logs and debug."),

    INVALID_FOLDER_FAILURE(400, "OMRS-FILE-REPOSITORY-400-085 ",
    ...
    INVALID_ENTITY_ERROR_EXCEPTIONNO_HISTORY(501, "OMRS-FILE-REPOSITORY-501-002 ",
...
//            "Request support through Egeria GitHub issue."),
    ...
    TYPEDEF_NAME_NOT_KNOWN(404, "OMRS-FILE-REPOSITORY-404-004",
    ...
    ENTITY_PROXY_ONLY(404, "OMRS-FILE-REPOSITORY-404-005",
